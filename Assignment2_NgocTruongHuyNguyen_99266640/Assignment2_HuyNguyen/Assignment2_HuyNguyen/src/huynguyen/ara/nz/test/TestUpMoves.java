package huynguyen.ara.nz.test;

import static org.junit.jupiter.api.Assertions.*;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;

import huynguyen.ara.nz.BlankSquare;
import huynguyen.ara.nz.Color;
import huynguyen.ara.nz.Direction;
import huynguyen.ara.nz.Game;
import huynguyen.ara.nz.Message;
import huynguyen.ara.nz.PlayableSquare;
import huynguyen.ara.nz.Shape;
...
class TestUpMoves {
	...
	void testGetsErrorMessageWhenMovingToDifferentColorAndShape() {
		Message[] expected = { Message.DIFFERENT_SHAPE_OR_COLOR, Message.DIFFERENT_SHAPE_OR_COLOR };
		game.addEyeball(6, 0, Direction.UP);
